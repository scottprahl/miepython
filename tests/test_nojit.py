"""Regression tests for Mie calculations with JIT disabled."""
...
from miepython.mie_nojit import _psi_downwards_py as psi_downwards

# imported after miepython so that the backend selected above is the one
# under test; this module imports miepython itself
from test_nojit_abcd import slow_cn_dn  # pylint: disable=wrong-import-order
...
class TestPerfectlyReflecting:
    """Test cases for perfectly reflecting behavior."""
