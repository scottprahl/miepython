...
plt.plot(ref_lam, qqabs, color='blue')
plt.plot(ref_lam, qqsca, color='red')

plt.title(r"Gold Spheres 100nm diameter")
plt.xlabel("Wavelength (nm)")
plt.ylabel(r"Cross Section ($\mu$m$^2$)")
plt.annotate("absorption", xy=(0.7,0.01), color='blue')
plt.annotate("scattering", xy=(0.75,0.1), color='red')
plt.show()
